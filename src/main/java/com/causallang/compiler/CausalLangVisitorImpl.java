...
/**
 * Implémentation du visiteur pour l'AST du langage Causal.
 * Cette classe fournit une implémentation basique du visiteur qui affiche
 * les éléments de l'AST lors de la visite.
 */
public class CausalLangVisitorImpl extends AbstractParseTreeVisitor<Object> implements CausalLangVisitor {
    ...
    // Visite du programme
    @Override
    public Object visitProgram(CausalLangParser.ProgramContext ctx) {
        System.out.println("Début de l'analyse du programme Causal");
        return visitChildren(ctx);
    }

    // Visite des déclarations
    @Override
    public Object visitDeclaration(CausalLangParser.DeclarationContext ctx) {
        return visitChildren(ctx);
    }

    // Visite des annotations
    @Override
    public Object visitAnnotationDecl(CausalLangParser.AnnotationDeclContext ctx) {
    ...
    @Override
    public Object visitFunctionDecl(CausalLangParser.FunctionDeclContext ctx) {
    ...
    @Override
    public Object visitTypeDecl(CausalLangParser.TypeDeclContext ctx) {
    ...
    @Override
    public Object visitNamespaceDecl(CausalLangParser.NamespaceDeclContext ctx) {
    ...
    @Override
    public Object visitImportDecl(CausalLangParser.ImportDeclContext ctx) {
    ...
    @Override
    public Object visitExpression(CausalLangParser.ExpressionContext ctx) {
        return visitChildren(ctx);
    }

    // Visite des littéraux
    @Override
    public Object visitLiteral(CausalLangParser.LiteralContext ctx) {
    ...
    @Override
    public Object visitReturnStmt(CausalLangParser.ReturnStmtContext ctx) {
    ...
    @Override
    public Object visitIfStmt(CausalLangParser.IfStmtContext ctx) {
    ...
    @Override
    public Object visitMatchStmt(CausalLangParser.MatchStmtContext ctx) {
